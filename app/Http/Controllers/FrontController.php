...
class FrontController extends Controller
{
    ...
    public function pdf($id)
    {
        ...
        // $pdf = PDF::loadView('detail_wilayah_pdf', compact('detail', 'attribut', 'kelurahan', 'jumlah_penduduk', 'jml_laki', 'jml_perempuan', 'jml_kepadatan', 'jml_luas'))->setPaper('landscape');
        // return $pdf->stream();
        return view('detail_wilayah_pdf', compact('detail', 'attribut', 'kelurahan', 'jumlah_penduduk', 'jml_laki', 'jml_perempuan', 'jml_kepadatan', 'jml_luas'));
    }
