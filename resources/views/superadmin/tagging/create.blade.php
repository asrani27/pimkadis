   ...
   <div class="row">
    <div class="col-md-12">
        <div class="box box">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" action="/superadmin/tagging/add" method="post">
                @csrf
              <div class="box-body">
                <div class="form-group">
                  <label for="inputEmail3" class="col-sm-2 control-label">Attribut</label>
                  <div class="col-sm-10">
                    <select name="attribut_id" class="form-control" required>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    ...
                    <a href="/superadmin/tagging" class="btn bg-gray btn-block"><i class="fa fa-arrow-left"></i> Kembali</a>
                  </div>
                </div>
              </div>
            </form>
